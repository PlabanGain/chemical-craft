  ...
  Widget build(BuildContext context) {
    return Consumer<GameState>(
      builder: (context, gameState, child) {
        final activeCraft = gameState.craftingQueue.isNotEmpty
            ? gameState.craftingQueue.first
            : null;
                  ...
                  gradient: LinearGradient(
                    colors: activeCraft != null
                        ...
                        : [
                            ...
                            Colors.white10.withOpacity(0.04),
                          ],
                  ),
                                ...
                                ClipRRect(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: LinearProgressIndicator(
                                      value:
                                          1.0 -
                                          (activeCraft.secondsRemaining /
                                              activeCraft.durationSeconds),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...gameState.recipes.map((recipe) {
                        final outputResource = gameState.resources.firstWhere(
                          (r) => r.type == recipe.outputType,
                        );
                        final outputColor = Color(
                          int.parse(outputResource.colorHex),
                        );
                        ...
                        recipe.inputs.forEach((resType, reqAmount) {
                          final playerRes = gameState.resources.firstWhere(
                            (r) => r.type == resType,
                          );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Wrap(children: ingredientBadges),
                                  ),
                                  const SizedBox(width: 10.0),
